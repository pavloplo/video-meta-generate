...
export const VideoPreviewPanel = ({
  ...
  // Render section content for thumbnails
  ...
  // Render section content for description
  ...
  // Render section content for tags
      ...
      <CardContent className="flex-1 overflow-y-auto space-y-6">
        ...
        {useAccordions ? (
          <Accordion
            title="Thumbnails"
            icon="📸"
            defaultOpen={variants.length > 0 || thumbnailsStatus === "loading"}
            isLoading={thumbnailsStatus === "loading"}
            hasError={thumbnailsStatus === "error"}
            hasContent={variants.length > 0}
          >
        ...
        {useAccordions ? (
          <Accordion
            title="Description"
            icon="📝"
            defaultOpen={!!description || descriptionStatus === "loading"}
            isLoading={descriptionStatus === "loading"}
            hasError={descriptionStatus === "error"}
        ...
        {useAccordions ? (
          <Accordion
            title="Tags"
            icon="🏷️"
            defaultOpen={tags.length > 0 || tagsStatus === "loading"}
            isLoading={tagsStatus === "loading"}
            hasError={tagsStatus === "error"}
